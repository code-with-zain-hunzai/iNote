    ...
    <>
      ...
      <div className="mx-3 md:container md:mx-auto my-5 rounded-xl p-5 bg-violet-100 min-h-[80vh] md:w-1/2">
        ...
        <div className="addTodo my-5 flex flex-col gap-3">
          ...
          <input onChange={handleChange} value={todo} type="text" className='w-full py-2 px-1 rounded-xl border-none outline-none' />
        ...
        <div className="todos">
          ...
          {todos.map(item => {
            return (showFinshed || !item.isCompleted) && <div key={item.id} className="todo flex justify-between my-3 md:w-1/2 ">
              <div className='flex gap-5'>
                <input
                  ...
                  className="mr-2"
                />
              <div className={`flex-wrap ${item.isCompleted ? "line-through" : ""}`}>{item.todo}</div>
              </div>
